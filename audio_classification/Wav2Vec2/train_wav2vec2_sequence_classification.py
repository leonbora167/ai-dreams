...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train Wav2Vec2 sequence classification on raw audio.")
...
def make_model_builder(model_name: str, freeze_feature_encoder: bool):
    def build_model(num_classes: int, label_names: list[str]) -> Wav2Vec2ForSequenceClassification:
...
def main() -> None:
    ...
    train_model(
        model_name="wav2vec2_seqcls",
        model_builder=make_model_builder(args.model_name, args.freeze_feature_encoder),
